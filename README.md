...
This project collects host and process metrics from Prometheus and streams live updates over encrypted WebSocket. There is no HTTP API — all data is delivered through the WebSocket channel.
...
- 📡 Real-time updates over WSS channel `metrics`.
